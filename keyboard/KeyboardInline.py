...
inline_keyboard = [
    [
        InlineKeyboardButton(BUTTON_ELECTRO, callback_data=str(BUTTON_ELECTRO)),
...
inline_keyboard3 = [
    ...
    [
        InlineKeyboardButton("LMS", url="https://lms.mospolytech.ru/"),
        InlineKeyboardButton("Личный \t Кабинет", url="https://e.mospolytech.ru/")
    ],
    [
...
admin_keyboard = [
    [
        InlineKeyboardButton("Кол-во пользователей", callback_data="Кол-во пользователей"),
        InlineKeyboardButton("Кол-во баз данных", callback_data="Бд")
    ]
]

managet_keyboard = [
    [
        InlineKeyboardButton("Кол-во групп", callback_data="Кол-во групп"),
        InlineKeyboardButton("Активность", callback_data="Активность")
    ]
]
